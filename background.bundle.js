...
module.exports = __webpack_require__.p + "platform.png";
...
/* harmony import */ var _img_platform_png__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_img_platform_png__WEBPACK_IMPORTED_MODULE_2__);



const REGEX_IQOPTION = /iqoption.*\/traderoom/gi

chrome.webRequest.onBeforeSendHeaders.addListener((details) => { 
  if (details.type == 'xmlhttprequest') {
	  for (let header of details.requestHeaders) {
	  	if (header.name == 'request-referer') {
	  		details.requestHeaders.push({name: 'Referer', value: header.value})
	  	}
	  }
  }
